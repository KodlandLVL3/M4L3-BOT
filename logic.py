...
if __name__ == '__main__':
    ...
    questions = [
        ...
        ("Найди самую маленькую по площади странц", "Ватикан", 10, 2, ''),
        ("У какой страны самая большая плотность населения?", "Монако", 10, 2, ''),
        ("В каком континенте находится страна со столицей Бастер?", "Северная Америка", 10, 2, ''),
        ("Сколько стран в Африке?", "53", 10, 2, ''),

        ("Какя столица у страны с численностью населения 1500001 человек?", "Манама", 20, 2, ''),
        ...
        ("Какая общая площадь всех стран Австралии и Окании?", "8490640.4", 30, 3, ""),
        ("В таблице info есть несколько стран, с процентом численности населения относительно численности Земли равным нулю. Определи среди этих стран ту, у которой самое длинное название столицы, в ответ напиши численность населения этой страны.", "100209", 30, 3, ""),
